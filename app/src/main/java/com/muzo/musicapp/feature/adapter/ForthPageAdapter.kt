...
class ForthPageAdapter(var musicList:List<FavLocalData>, val onDeleteClickListener: (item: FavLocalData) -> Unit): RecyclerView.Adapter<ForthPageAdapter.ViewHolder>() {
